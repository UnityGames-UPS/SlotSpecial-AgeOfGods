...
public class UIManager : MonoBehaviour
{
  ...
  private void Start()
  {
    ...
    SetButton(GameExit_Button, () => { CloseAutoSpinPanel?.Invoke(); OpenPopup(QuitPopupObject); });
    SetButton(paytable_Button, () => { CloseAutoSpinPanel?.Invoke(); OpenPopup(payTablePopup_Object); });
  ...
  internal void SetPlayerBalance(double amount)
  {
    ...
    if (playerBalanceSecondary != null) playerBalanceSecondary.text = formatted;
  }
